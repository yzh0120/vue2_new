<template>
  <el-aside width="auto">
    <div class="sidebar-container" :class="{'isCollapse':isCollapse}">
      <Logo></Logo>
      <el-scrollbar wrap-class="scrollbar-wrapper" ref="scrollbarRef" style="height:calc(100% - 50px) !important">
        <el-menu :collapse="isCollapse" :collapse-transition="false" :unique-opened="false" :default-active="activeName" @select="selectMenu">
...
/*********************************************************************************************************
        侧边栏的滚动条系列  .scrollbar-wrapper 和 .el-scrollbar__wrap 都是在同一个dom上    。scrollbar-wrapper是自定义的类名
        */
